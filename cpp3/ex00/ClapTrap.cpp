...
/*   Updated: 2024/11/09 16:02:40 by malanglo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _name("Carl"), _hitPoints(10), _energyPoints(10), _attackDamage(0) {
...
ClapTrap::ClapTrap(std::string name) : _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) {
    ...
    std::cout << GREEN << "Constructor taking name " << this->getName() << " in argument called for ClapTrap Class." << RESET << std::endl;
    return ;
}
